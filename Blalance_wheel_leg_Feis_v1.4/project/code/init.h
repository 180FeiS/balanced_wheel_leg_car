...
#define SERVO1_MID              (3301)//旧(4501)新 (3301)         //舵机1中值     左上 
#define SERVO2_MID              (4012)//旧5312) 新   4012    //舵机2中值     左下  大 上
#define SERVO3_MID              (5570)//旧(4070)新   5570      //舵机3中值     右上  小 下
#define SERVO4_MID              (4750)//旧(2950)新 4750       //舵机4中值     右下  大 下
