...
#define SERVO1_MID              (3600)//旧(4501) 新   4051       //舵机1中值     左上 小上
#define SERVO2_MID              (5562)//旧(5312) 新   4762    //舵机2中值     左下  大 上
#define SERVO3_MID              (4620)//旧(4070) 新   4820      //舵机3中值     右上  小 下
#define SERVO4_MID              (3100)//旧(2950) 新   4000       //舵机4中值     右下  大 下
