...
// ����˵��     *pid               ���ö���
              ...
              pid_type           PID����
// ���ز���     null
// ʹ��ʾ��     pid_init(&pid, kp, ki, kd, 0.001, 0, 0, FALSE, 10000, Position_pid);
// ��ע��Ϣ     ��ʼ������
-------------------------------------------------------------------------------------------------------------------*/
...
// ����˵��     *pid            ���ö���
              observation     ʵ��ֵ
// ���ز���     null
// ʹ��ʾ��     pid_set_target(&pid, observation);
// ��ע��Ϣ     ѭ���ڲ�����
-------------------------------------------------------------------------------------------------------------------*/
...
// ����˵��     pid_type       ����PID����
// ���ز���     null
// ʹ��ʾ��     *pid_type_to_string(pid_type);
// ��ע��Ϣ     �����ڲ�����, 0Ϊ����ʽ, 1Ϊλ��ʽ
-------------------------------------------------------------------------------------------------------------------*/
